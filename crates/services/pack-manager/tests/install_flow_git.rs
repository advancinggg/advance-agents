...
fn make_installer(packs_dir: &std::path::Path) -> Installer {
    // PACK-GAP-CLOSURE P1 (§2.0): builder form — new fields added by later lanes
...
fn t71_git_url_scheme_whitelist_rejects_invalid_schemes() {
    ...
    // PACK-GAP-CLOSURE P3 (§4.2): the scheme gate now runs BEFORE the
...
fn t71b_git_ref_grammar_comprehensive_positive_and_negative() {
    ...
    // PACK-GAP-CLOSURE P3 (§4.2): slash refs and 40-hex commit pins are now
