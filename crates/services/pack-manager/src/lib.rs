...
//!   (PACK-GAP-CLOSURE P3 #3); `list_versions` is a default method here.
//! - PACK-GAP-CLOSURE P3 (docs/plans/PACK-GAP-CLOSURE.md §4): signed manifests
...
//! - PACK-GAP-CLOSURE P2 (docs/plans/PACK-GAP-CLOSURE.md §3): workflow
