...
//! - PACK-GAP-CLOSURE P1: `provides(name, version)` enumerates an installed pack's
...
pub trait PackRegistry: Send + Sync {
    ...
    /// PACK-GAP-CLOSURE P1 (§2.3): every `provides:` entry (all 11 component
...
impl InMemoryPackRegistry {
    /// PACK-GAP-CLOSURE P1 (§2.2): installed packs (other than `{name}@{version}`
