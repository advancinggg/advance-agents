...
//!
//! Pack lane P3: step ③b — after checksum verification and
...
pub struct Installer {
    ...
    /// Pack lane P3: hex-encoded ed25519 public keys
...
impl Installer {
    ...
    /// Pack lane P3: the ed25519 trust roots (hex public keys)
...
/// Pack lane P3: facts about the step-③b signature outcome
...
impl Installer {
    ...
    pub(crate) async fn install_with_context(
        ...
        // ③b Pack lane P3: signed manifest. Verifies `pack.sig`
